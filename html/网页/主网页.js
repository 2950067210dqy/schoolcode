...
function lunbokaishi(){
	...
	var a= setInterval(function() {lunbo(-1700);}, 2000)
...
function lunbo(zhi){
	var a=document.getElementById("lunboimg"); 
	var yuandian1=document.getElementById('x1');
	var yuandian2=document.getElementById('x2');
	var yuandian3=document.getElementById('x3');
	var yuandian4=document.getElementById('x4');
	if(parseInt(a.style.left)>-6800&&temp<4)
		{		var newleft=parseInt(a.style.left)+zhi;
		 ...
		 if(temp===1)
			{		
				...
				yuandian1.style="";
				yuandian2.style="background:red";
		 ...
		 if(temp===2)
			{		
				yuandian2.style=" ";
				yuandian3.style="background:red";
		 ...
		 if(temp===3)
			{		
				yuandian3.style=" ";
				yuandian4.style="background:red";
				...
				a.style.left=-1700+'px';
				yuandian4.style=" ";
				yuandian1.style="background:red";
				temp=0;
		}
	}
